...
<Info>
  **Referencia Interactiva de API**
  ...
  Puedes explorar todos los endpoints de la API de forma interactiva en la pestaña [API Reference](/api-reference). Allí encontrarás la documentación completa generada automáticamente desde nuestra especificación OpenAPI, con la capacidad de probar los endpoints directamente.
</Info>

## Consideraciones‍

La API de woku está documentada siguiendo el estándar **OpenAPI 3.0**. Puedes acceder a la documentación interactiva de Swagger en: [https://clientapi.woku.app/documentation](https://clientapi.woku.app/documentation)
...
<div style={{ textAlign: 'center', fontSize: '0.875rem', color: '#6b7280' }}><strong>Vista de la ventana de información de la empresa en la aplicación del cliente.</strong></div>
