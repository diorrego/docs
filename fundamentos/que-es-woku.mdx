...
<div style={{ textAlign: 'center', fontSize: '0.875rem', color: '#6b7280' }}><strong>Calificación de un woku en la interfaz de celular.</strong></div>
...
<div style={{ textAlign: 'center', fontSize: '0.875rem', color: '#6b7280' }}><strong>woku es la herramienta más rápida del mercado para entender a tu cliente.</strong></div>
